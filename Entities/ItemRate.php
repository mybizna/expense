...
class ItemRate extends BaseModel
{
     ...
     * @var array<string>
     */
    public array $migrationDependancy = ['expense_item', 'account_rate'];
    /**
    ...
    public function fields(Blueprint $table = null): void
    {
        ...
        $this->fields->foreignId('expense_item_id')->html('recordpicker')->relation(['expense_', 'item']);
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ...
            ['label' => 'Expense Item Rate', 'class' => 'col-span-full md:col-span-6', 'fields' => ['slug', 'rate_id', 'expense_item_id', 'method']],
            ['label' => 'Setting', 'class' => 'col-span-full md:col-span-6', 'fields' => ['value', 'ordering', 'on_total']],
        ];
